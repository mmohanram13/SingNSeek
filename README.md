...
- Natural language queries: "pop songs by voiceofruthie about apocalypse"_
...
- Streamlit UI with text-only design
...
- Go to **Manage** tab
- Click **Create Index**
- Click **Load Demo Data** (takes 2-5 minutes)
...
**Mohan Ram**  
GitHub: [@mmohanram13](https://github.com/mmohanram13) | LinkedIn: [Mohan Ram](https://www.linkedin.com/in/mmohanram13)
...
For issues or contributions, visit the [GitHub repository](https://github.com/mmohanram13/singnseek)